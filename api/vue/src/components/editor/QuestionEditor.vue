<template>
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
            ...
            <button
                ...
                class="flex items-center text-xs py-1 px-3 rounded-sm border border-transparent text-red-500 hover:text-red-600"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-3">
            ...
            >
                <option v-for="type in questionTypes" :value="type" :key="type">
                    {{ upperCaseFirst(type) }}
                </option>
            </select>
        </div>
...
// if questions should have options
...
function dataChange() {
    // For clowwning the values, Prevent it to be lost
